...
- расчёт anomaly score для каждой записи
- экспорт enriched CSV с prediction и score
- визуализация аномалий в виде scatter plot
- risk-level классификация для подозрительных записей
